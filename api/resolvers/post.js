...
const Mutation = {
  ...
  createPost: async (
    ...
    if (!title && !image) {
      throw new Error('Le titre ou l\'image est obligatoire.');
    }
    ...
    if (image) {
      ...
      if (!uploadImage.secure_url) {
        throw new Error(
          'Une erreur c\'est produite lors du téléchargement de l\'image sur Cloudinary'
        );
      }
  ...
  deletePost: async (
    ...
    if (imagePublicId) {
      ...
      if (deleteImage.result !== 'ok') {
        throw new Error(
          'Une erreur c\'est produite lors de la suppression de l\'image de Cloudinary'
        );
      }
    }
